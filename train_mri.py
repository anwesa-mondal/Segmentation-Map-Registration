...
class Config:
    ...
    def __init__(self):
        ...
        # Data Augmentation
        self.contrast_augmentation = True  # Make model contrast-agnostic (robust to T1/T2/FLAIR/etc.)
        
        # Optimizer - using cosine annealing with warmup
        self.lr = 1e-4               # Initial LR
        self.min_lr = 1e-6           # Minimum LR
        self.weight_decay = 1e-5
        self.warmup_epochs = 5       # Warmup period
        ...
        # Resume
        self.resume_from = None      # Path to checkpoint to resume from
