...
if __name__ == "__main__":
    # Test dataset loading (adjust paths as needed)
    ...
    if os.path.exists(data_list) and os.path.exists(template_mri):
        dataset = MRIDataset(data_list, template_mri, template_seg)
        ...
        print("Test data not found. Run convert_brain_mri.py first.")
